...
<head>
    ...
    <script>
        ...
        function insertindent() {
            var i1=$("#tt").text();
            var i2="<%=session.getAttribute("upname")%>"
            var i3=$("#number").val();
            var i4=$("#dz").val();
            var i5=$(".good_total").text();
            var param="goodname="+i1+"&username="+i2+"&number="+i3+"&address="+i4+"&price="+i5;
...
<%
    ...
    String name= Orderlist_Use.searchNameById(id);    //根据id查询名字
    String price= Orderlist_Use.searchPriceById(id);   //根据id查询价格
    String image= Orderlist_Use.searchImageById(id);  //根据id查询商品图片
%>
<%--商品列表展示--%>
<div class="main_down">
    <div class="mainwdow">
    ...
    <tr><td><div class="shopname"><h1 id="tt" value="狗牙披萨卷"><%=name%></h1>
        ...
        <tr><td>单价：<i class="goods_price"><%=price%></i>元</td></tr>
    </tr>
        <tr><td>
